...
def generate_even_digit_square(start,end):
  """Generate a list of four_digit numbers thar are perfct squares with all even digits"""
  even_digit_squares=[]
...
print'the four_digit_numbers thar are perfect squares with all even digits are:',result
